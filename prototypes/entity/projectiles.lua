...
------------------------------------------------
    ...
    animation =
    {
      filename = "__KrastorioPorted__/graphics/entity/turrets/railbullet.png",
      frame_count = 1,
      width = 5,
      height = 90,
      priority = "high"
    ...
    animation =
    {
      filename = "__KrastorioPorted__/graphics/entity/turrets/missile-e.png",
      frame_count = 1,
      width = 5,
      height = 90,
      priority = "high"
    ...
    animation =
    {
      filename = "__KrastorioPorted__/graphics/entity/turrets/missile-m.png",
      frame_count = 1,
      width = 10,
      height = 167,
      priority = "high"
...
-----------------------------------------------------------------------------------------------------------------
    ...
    animation =
    {
      filename = "__KrastorioPorted__/graphics/entity/turrets/rocket.png",
      frame_count = 5,
      line_length = 5,
      width = 13,
      height = 100,
    ...
    shadow =
    {
      filename = "__KrastorioPorted__/graphics/entity/turrets/rocket-shadow.png",
      frame_count = 1,
      width = 12,
      height = 40,
      priority = "high",
    ...
    animation =
    {
      filename = "__KrastorioPorted__/graphics/entity/turrets/rocket-n.png",
      frame_count = 5,
      line_length = 5,
      width = 13,
      height = 100,
    ...
    animation =
    {
      filename = "__KrastorioPorted__/graphics/entity/turrets/rocket-m.png",
      frame_count = 5,
      line_length = 5,
      width = 13,
      height = 100,
