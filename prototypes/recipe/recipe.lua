...
----------------------------------------------------------------------------------------------------------------- 
	...
	},
	{
		...
		name = "enriched-iron",
		category = "chemistry",
		icon = "__Krastorio__/graphics/icons/enriched-iron.png",
		icon_size = 32,
		energy_required = 3,
		enabled = false,
		ingredients =
	...
	},
	{
		...
		name = "menarite",
		category = "chemistry",
		icon = "__Krastorio__/graphics/icons/menarite.png",
		icon_size = 32,
		subgroup = "intermediate-product",
		order = "q1[menarite]",
		energy_required = 20,
	...
	},
	{
		...
		name = "imersite",
		category = "chemistry",
		icon = "__Krastorio__/graphics/icons/imersite.png",
		icon_size = 32,
		subgroup = "intermediate-product",
		order = "q2[imersite]",
		energy_required = 30,
    ...
    },
	{
		...
		icon = "__Krastorio__/graphics/icons/k-deuterium-oxide.png",
		icon_size = 32,
		energy_required = 120,
		enabled = false,
		ingredients = 
...
-----------------------------------------------------------------------------------------------------------------   
	...
	},	
	{
		type = "recipe",
		name = "sand-to-quartz",
		icon = "__Krastorio__/graphics/icons/quartz.png",
		icon_size = 32,
		energy_required = 2,
		subgroup = "raw-material",
    ...
    },
	{
		...
		icon = "__Krastorio__/graphics/icons/enriched-copper.png",
		icon_size = 32,
		category = "chemistry",
		energy_required = 3,
		enabled = false,
    ...
    },
	{
		...
		category = "matter-converter",
		icon = "__Krastorio__/graphics/icons/recipes/mip/uncompress-matter.png",
		icon_size = 64,
		energy_required = 5,
		enabled = false,
		ingredients =
    ...
    },	
	{
		...
		icon = "__Krastorio__/graphics/icons/filtering.png",
		icon_size = 32,
		energy_required = 600,
		enabled = false,
		hidden = true,
    ...
    },
	{
		...
		name = "k-fusion",
		category = "k-fusion",
		icon = "__Krastorio__/graphics/icons/recipes/mip/fusion-energy.png",
		icon_size = 64,
		energy_required = 3,
		enabled = true,
		hidden = true,
